 ...
 * @author Richard
 *
 * @param <T>	The type of the component this export source is capable of
 * processing.
...
public interface IExportSource<T, C> {
    ...
    /**
     * Gets the class type of the component this export source is capable of
     * processing.
     *
     * @return The class type of the component this export source is capable of
     * processing.
     */
    Class<T> getSourceType();

    /**
     * Gets the default configuration options for this export source. The
     * options returned by this method will be used during the export process if
     * the user did not define any.
     *
    ...
    /**
     * Gets the number of columns that will be exported from the given source
     * instance using the given configuration options.
     *
     ...
     * {@link com.lapis.jsfexporter.DataExporter DataExporter} to perform the
     * export. Implementations should invoke
     * {@link IExportType#exportRow(com.lapis.jsfexporter.api.IExportRow)} as
     * many times as needed, but must not call any other IExportType methods!
     *
     * @param source	A component instance of the type supported by this source.
     * @param configOptions	The configuration options in use for the export.
     * @param exporter	An instance of the export type in use for the export.
     * @param context	The FacesContext for the current request.
     * @throws Exception	Implementations may throw any exception for any reason.
     * Exceptions thrown will propagate out and be processed by the normal JSF
