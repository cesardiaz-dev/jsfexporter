 ...
 * <code>com.lapis.jsfexporter.spi.IExportTypeFactory</code> in the
 * <code>META-INF/services</code> directory. The file must contain the
 ...
 * @param <C>	The type of the configuration options used by the produced export
 * type.
...
public interface IExportTypeFactory<T, C, R> {
    ...
    /**
     * Gets the default configuration options for the produced export type. The
    ...
    /**
     * Gets the unique identifier for this export type factory. The returned
     * value will be matched against the fileType parameter on the
     * <code>dataExporter</code> tag to determine which export type should be
     * used during a given export. The value may be the same as the file type
     * produced by instances of the export type, but may be something else if
     * that is convenient or if an export type can produce multiple types of
     * files.
     *
